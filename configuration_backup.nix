...

{
  imports =
    [
      <nixos-hardware/dell/precision/5570>
  ...
  boot = {
    ...
    initrd = {
      ...
      luks.devices = {
        "luks-eb815ba0-174e-4a15-bbcd-4375fd8d42f2" = {
          crypttabExtraOpts = [
            "fido2-device=auto"
          ];
          device = "/dev/disk/by-uuid/eb815ba0-174e-4a15-bbcd-4375fd8d42f2";
          #fido2.passwordLess = true;
        };
        "luks-eba9c23e-14d1-4d14-8560-5c7e87832ce8" = {
          crypttabExtraOpts = [
            "fido2-device=auto"
          ];
          device = "/dev/disk/by-uuid/eba9c23e-14d1-4d14-8560-5c7e87832ce8";
        };
      };
    };
  };
  ...
  fileSystems."/" = {
    device = "/dev/mapper/luks-eb815ba0-174e-4a15-bbcd-4375fd8d42f2";
    fsType = "btrfs";
  };

  networking.hostName = "foxpad-ultra"; # Define your hostname.
